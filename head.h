...
//    vector<map<pair<int,int>,unordered_set<int>>> BP_Flag;//for each partition, map from boundary edges (smaller ID, larger ID) to its affected partitions
    ...
    void RetrievePathCH(int ID1, int ID2, int finalID, vector<int> &preceF, vector<int> &preceB,
    ...
    pair<double, double>
    ThroughputEstimate(vector<vector<double>> &query_costs, vector<vector<double>> &update_costs, double threshold_time,
                       double T);

    double analytical_update_first(double T_q, double T_u, double T_r, double T, double V_q);

    double
    ThroughputSimulate(vector<vector<double>> &query_costs, vector<vector<double>> &update_costs, int simulation_time,
                       double threshold_time, double period_time, double queryTime, int workerNum);

    double ThroughputSimulateReal(vector<vector<double>> &query_costs, vector<vector<double>> &update_costs,
    ...
    pair<double, double> simulator_UpdateFirstVPL(vector<pair<int, int>> &ODpair, vector<vector<double>> &query_cost,
                                                  vector<vector<double>> &update_cost, vector<query> &queryList, int T,
                                                  double period_time, int workerNum);
...
//    void deleteEOrderGenerate(int u,int v);
    ...
    void Repair_PartiIndex(bool ifParallel, bool ifIncrease,
                           map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch);

    void Repair_PartiIndexPostMHLPost(bool ifParallel, int updateType,
                                      map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch, double &runT);

    void Repair_PartiIndexForOpt(bool ifParallel, bool ifIncrease,
                                 map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch);

    void RepairPartitionIndexV(vector<int> &p, bool ifIncrease,
                               map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch, bool ifOpt);

    void RepairPartitionIndexDecrease(int pid, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch);

    void
    RepairPartitionIndexDecreaseForOpt(int pid, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch);

    void RepairPartitionIndexIncrease(int pid, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch);

    void
    RepairPartitionIndexIncreaseForOpt(int pid, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch);

    void PostMHLIndexUpdatePostPartV(vector<int> &p, bool ifIncrease);

    void PostMHLIndexUpdatePostPart(int pid, bool ifIncrease);

    void PostMHLIndexUpdatePostPartDFS(int pid, int p, vector<int> &ancestor, vector<int> &interface,
                                       vector<map<int, int>> &disInfs, int rootHeight, bool ifIncrease);

    void PostMHLIndexUpdatePostPartDFS(int pid, int p, vector<int> &ancestor, vector<int> &interface,
                                       vector<map<int, int>> &disInfs, set<int> &vertexIDChL, int rootHeight,
                                       bool ifIncrease, Timer &tt);
    ...
    void VPLmakeIndexDFSPartiPost(int p, vector<int> &ancestor, vector<int> &interface,
                                  map<int, unordered_map<int, int>> &disInfs);
    ...
    void VPLBatchUpdateMixSchedule(vector<pair<pair<int, int>, pair<int, int>>> &wBatchDec,
                                   vector<pair<pair<int, int>, pair<int, int>>> &wBatchInc, int batch_i, double &runT1);

    void VPLBatchUpdateMix(vector<pair<pair<int, int>, pair<int, int>>> &wBatchDec,
                           vector<pair<pair<int, int>, pair<int, int>>> &wBatchInc, int batch_i, double &runT1);

    void VPLBatchUpdateDec(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, int batch_i, double &runT1);

    void VPLShortcutUpdate(map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatchDecSchedule,
    ...
    void
    DecreasePartiBatchVPLShortcut(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree,
                                  vector<int> &rank, int heightMax, vector<pair<pair<int, int>, int>> &updatedSC);

    void DecreasePartiBatchVPLShortcutV(vector<int> p, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &wBatch,
                                        vector<Node> &Tree, vector<int> &rank, int heightMax,
                                        vector<vector<pair<pair<int, int>, int>>> &updatedSCs);

    void DecreasePartiBatchUpdateCheckVPL(map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch,
                                          vector<pair<pair<int, int>, pair<int, int>>> &overlayBatch, bool ifParallel);

    void
    DecreaseOverlayBatchVPL(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree, vector<int> &rank,
                            int heightMax, bool ifLabelU);

    void
    DecreaseOverlayBatchLabelVPL(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                                 set<int> &vertexIDChL);

    void EachNodeProBDis5VPLOverlay(int child, vector<int> &line, set<int> &vertexIDChL, vector<Node> &Tree,
                                    vector<int> &rank);

    void
    MixRepair_PartiIndexVPLPost(bool ifParallel, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatchDec,
                                map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatchInc, double &runT);

    void MixRefreshCrossLabelsVPL(bool ifParallel, double &runT, int threadNum);

    void Repair_PartiIndexVPLPost(bool ifParallel, int updateType,
                                  map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch, double &runT);
    ...
    void VPLIndexUpdatePostPartiDFS(int pid, int p, vector<int> &ancestor, vector<int> &interface,
                                    vector<map<int, int>> &disInfs, set<int> &vertexIDChL, int rootHeight,
                                    bool ifIncrease, Timer &tt);

    void RefreshCrossLabelsVPL(bool ifParallel, bool ifIncrease, double &runT, int threadNum);

    void DecreasePartiBatchLabelVPLCrossRoot(int ProBeginVertexID, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                             set<int> &vertexIDChL);

    void DecreasePartiBatchLabelVPLCross(int pid, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                         vector<int> &ProBeginVertexSet, set<int> &vertexIDChL);

    void DecreasePartiBatchLabelVPLCrossV(vector<int> &p, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                          vector<vector<int>> &ProBeginVertexSetV, set<int> &vertexIDChL);

    void IncreasePartiBatchLabelVPLCrossRoot(int ProBeginVertexID, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                             vector<vector<int>> &VidtoTNid);

    void IncreasePartiBatchLabelVPLCross(int pid, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                         vector<int> &ProBeginVertexSet, vector<vector<int>> &VidtoTNid);

    void IncreasePartiBatchLabelVPLCrossV(vector<int> &p, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                          vector<vector<int>> &ProBeginVertexSetV, vector<vector<int>> &VidtoTNid);

    void VPLBatchUpdateInc(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, int batch_i, double &runT1);

    void IncreasePartiBatchUpdateCheckVPL(map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch,
                                          vector<pair<pair<int, int>, pair<int, int>>> &overlayBatch, bool ifParallel);

    void MixVPLBatchShortcutUpdateOverlay(vector<pair<pair<int, int>, pair<int, int>>> &wBatchDec,
                                          vector<pair<pair<int, int>, pair<int, int>>> &wBatchInc, vector<Node> &Tree,
                                          vector<int> &rank, int heightMax,
                                          vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                                          vector<vector<int>> &VidtoTNid, bool ifLabelU);

    void MixVPLBatchShortcutUpdateParti(map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatchDec,
                                        map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatchInc,
                                        vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchDec,
                                        vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchInc, bool ifParallel);

    void MixPartiBatchVPLShortcut(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatchDec,
                                  vector<pair<pair<int, int>, pair<int, int>>> &wBatchInc, vector<Node> &Tree,
                                  vector<int> &rank, int heightMax, vector<pair<pair<int, int>, int>> &updatedSCDec,
                                  vector<pair<pair<int, int>, int>> &updatedSCInc);

    void MixPartiBatchVPLShortcutV(vector<int> &p,
                                   map<int, pair<vector<pair<pair<int, int>, pair<int, int>>>, vector<pair<pair<int, int>, pair<int, int>>>>> &partiBatch,
                                   vector<Node> &Tree, vector<int> &rank, int heightMax,
                                   vector<vector<pair<pair<int, int>, int>>> &updatedSCDec,
                                   vector<vector<pair<pair<int, int>, int>>> &updatedSCInc);

    void
    IncreasePartiBatchVPLShortcut(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree,
                                  vector<int> &rank, int heightMax, vector<pair<pair<int, int>, int>> &updatedSC);

    void IncreasePartiBatchVPLShortcutV(vector<int> p, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &wBatch,
                                        vector<Node> &Tree, vector<int> &rank, int heightMax,
                                        vector<vector<pair<pair<int, int>, int>>> &updatedSCs);

    void
    IncreaseOverlayBatchVPL(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree, vector<int> &rank,
                            int heightMax, vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                            vector<vector<int>> &VidtoTNid, bool ifLabelU);

    void eachNodeProcessIncrease1VPLOverlay(int children, vector<int> &line, int &changelabel, vector<Node> &Tree,
                                            vector<int> &rank, vector<vector<int>> &VidtoTNid);

    void
    IncreaseOverlayBatchLabelVPL(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                                 vector<vector<int>> &VidtoTNid);

    void MixOverlayBatchLabelVPL(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                                 vector<vector<int>> &VidtoTNid, set<int> &vertexIDChL);

    void MixVPLPartiLabelUpdateTopDownV(vector<int> &p, vector<map<pair<int, int>, pair<int, int>>> &wBatchDec,
                                        vector<map<pair<int, int>, int>> &wBatchInc, vector<Node> &Tree,
                                        vector<int> &rank, vector<vector<int>> &VidtoTNid);

    void MixVPLPartiLabelUpdateTopDown(int pid, map<pair<int, int>, pair<int, int>> &wBatchDec,
                                       map<pair<int, int>, int> &wBatchInc, vector<Node> &Tree, vector<int> &rank,
                                       vector<vector<int>> &VidtoTNid);

    void
    MixVPLOverlayLabelUpdateTopDown(map<pair<int, int>, pair<int, int>> &wBatchDec, map<pair<int, int>, int> &wBatchInc,
                                    vector<Node> &Tree, vector<int> &rank, vector<vector<int>> &VidtoTNid);

    void
    MixVPLOverlayLabelUpdateBySet(map<pair<int, int>, pair<int, int>> &wBatchDec, map<pair<int, int>, int> &wBatchInc,
                                  vector<Node> &Tree, vector<int> &rank, vector<vector<int>> &VidtoTNid,
                                  set<int> &vertexIDChL);

    void
    MixVPLPartiLabelUpdateBySetV(vector<int> &p, vector<Node> &Tree, vector<int> &rank, vector<vector<int>> &VidtoTNid,
                                 set<int> &vertexIDChL);

    void MixVPLPartiLabelUpdateBySet(int pid, map<pair<int, int>, pair<int, int>> &wBatchDec,
                                     map<pair<int, int>, int> &wBatchInc, vector<Node> &Tree, vector<int> &rank,
                                     vector<vector<int>> &VidtoTNid, set<int> &vertexIDChL);

    void TreeNodeMixUpdateVPLOverlay(int children, vector<int> &line, vector<Node> &Tree, vector<int> &rank,
                                     vector<vector<int>> &VidtoTNid, set<int> &vertexIDChL);

    void TreeNodeMixUpdateVPL(int child, vector<int> &line, vector<Node> &Tree, vector<int> &rank,
                              vector<vector<int>> &VidtoTNid, set<int> &vertexIDChL);

    void TreeNodeMixUpdateWhileVPL(int child, vector<int> &line, vector<Node> &Tree, vector<int> &rank,
                                   vector<vector<int>> &VidtoTNid, set<int> &vertexIDChL);

    void
    MixPartiBatchCrossLabelVPL(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                               vector<vector<int>> &VidtoTNid, set<int> &vertexIDChL);

    void MixPartiBatchCrossLabelVPLV(vector<int> &p, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                     vector<vector<int>> &ProBeginVertexSet, vector<vector<int>> &VidtoTNid,
                                     set<int> &vertexIDChL);

    void MixPartiBatchLabelVPLCrossRoot(int ProBeginVertexID, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                        vector<vector<int>> &VidtoTNid, set<int> &vertexIDChL);
    ...
    void VPLInnerUnaffectedPartiDetect(vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchDec,
                                       vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchInc, bool ifParallel);

    void VPLInnerUnaffectedPartiDetectOverlayDec(vector<bool> &innerAffectTemp);

    void VPLInnerUnaffectedPartiDetectBFS(vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchDec,
                                          vector<bool> &innerAffectTemp);

    void VPLOverlayGraphUpdate(vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchDec,
                               vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchInc, bool ifParallel);
    ...
    void VPLBPFlagUpdate(vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchDec,
                         vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchInc, bool ifParallel);
    ...
    void BPFlagUpdateSPTreeVertex(int ID1, int ID2,
                                  vector<int> &pTree);//detect the affected queries by amalgamating SP trees
    ...
    void ThreadDistributeBP(vector<pair<pair<int, int>, pair<int, int>>> &overlayBatch,
    ...
    void VPLUnaffectedPartiDetectTruth(vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchDecSchedule,
                                       vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchIncSchedule,
                                       double &tDetect, vector<pair<bool, int>> &partiAffectInfo);

    void
    VPLInnerUnaffectedPartiDetectByOracle(map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatchDecSchedule,
                                          map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatchIncSchedule,
                                          vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchDecSchedule,
                                          vector<pair<pair<int, int>, pair<int, int>>> &overlayBatchIncSchedule,
                                          int &upNum, double &tDetect, vector<pair<bool, int>> &partiAffectInfo);

    void DistanceOracleTestParti(int pid, vector<bool> &affectedP, unordered_set<int> &affectedPSet, queue<int> &mq);

    void
    DistanceOracleTestPartiV(vector<int> &p, vector<bool> &affectedP, unordered_set<int> &affectedPSet, queue<int> &mq);

    void EachNodeProBDisUpdateRange(int child, vector<int> &line, set<int> &vertexIDChL, vector<Node> &Tree,
                                    vector<int> &rank, pair<int, int> &p, bool &ProDisChange);

    void
    EachNodeProBDisUpdate(int child, vector<int> &line, set<int> &vertexIDChL, vector<Node> &Tree, vector<int> &rank,
                          bool ifParallel);

    void EachNodeProBDisUpdateVert(int child, vector<int> &line, set<int> &vertexIDChL, vector<Node> &Tree,
                                   vector<int> &rank, pair<int, int> &p, bool &ProDisChange);
    ...
    void GetPartiRootCandidates(int p, int upperB, int lowerB, vector<pair<int, int>> &candidates,
                                map<int, vector<int>> &candidatesMap);
    ...
    void PostMHLmakeIndexDFSPartiPost(int p, vector<int> &ancestor, vector<int> &interface,
                                      map<int, unordered_map<int, int>> &disInfs);
    ...
    void BoundShortcutsCheckPartiV(pair<int, int> pRange, vector<int> &pids,
                                   vector<vector<pair<pair<int, int>, pair<int, int>>>> &affectedShortcuts,
                                   int updateType);

    void
    BoundShortcutsCheckParti(int pid, vector<pair<pair<int, int>, pair<int, int>>> &affectedShortcut, int updateType);
    ...
    void
    AncestorEntryDecreaseUpdate(int pid, int child, vector<int> &line, vector<int> &interfaces, set<int> &vertexIDChL,
                                map<int, int> &checkedDis, vector<Node> &Tree, vector<int> &rank, int rootHeight);

    void ThreadDistribute(vector<int> &vertices, vector<vector<int>> &processID);

    void ConstructPH2H_PartiV(vector<int> &P, vector<vector<Node>> &Trees, vector<vector<int>> &ranks,
                              vector<map<int, vector<pair<int, int>>>> &SCconNodesMTP, vector<vector<int>> &VidtoTNidP,
                              vector<int> &heightMaxs, vector<vector<int>> &toRMQs,
                              vector<vector<vector<int>>> &RMQIndexs);

    void ConstructPH2H_PartiVCH(vector<int> &P, vector<vector<Node>> &Trees, vector<vector<int>> &ranks,
                                vector<map<int, vector<pair<int, int>>>> &SCconNodesMTP,
                                vector<vector<int>> &VidtoTNidP, vector<int> &heightMaxs, vector<vector<int>> &toRMQs,
                                vector<vector<vector<int>>> &RMQIndexs);

    void ConstructPH2H_Parti(int pid, vector<vector<Node>> &Trees, vector<vector<int>> &ranks,
                             vector<map<int, vector<pair<int, int>>>> &SCconNodesMTP, vector<vector<int>> &VidtoTNidP,
                             vector<int> &heightMaxs, vector<vector<int>> &toRMQs,
                             vector<vector<vector<int>>> &RMQIndexs);
...
//    void ConstructPH2H_PartiNoLabel(int pid, vector<vector<Node>>& Trees, vector<vector<int>>& ranks, vector<map<int, vector<pair<int,int>>>>& SCconNodesMTP, vector<vector<int>>& VidtoTNidP, vector<int>& heightMaxs, vector<vector<int>>& toRMQs, vector<vector<vector<int>>>& RMQIndexs);
    void ConstructPH2H_PartiLabel(int pid, vector<vector<Node>> &Trees, vector<vector<int>> &ranks,
                                  vector<map<int, vector<pair<int, int>>>> &SCconNodesMTP,
                                  vector<vector<int>> &VidtoTNidP, vector<int> &heightMaxs, vector<vector<int>> &toRMQs,
                                  vector<vector<vector<int>>> &RMQIndexs);

    void H2HCreateTree_Parti(int pid, vector<Node> &TreeP, vector<int> &rankP,
                             vector<map<int, vector<pair<int, int>>>> &SCconNodesMTP, vector<vector<int>> &VidtoTNidP,
                             vector<int> &heightMaxs);//Create tree for partition
    ...
    void makeRMQCoreP(int pid, vector<vector<int>> &toRMQs, vector<vector<vector<int>>> &RMQIndexs,
                      vector<vector<Node>> &Trees);

    void makeRMQDFSCoreP(int pid, int p, int height, vector<int> &EulerSeqP, vector<vector<int>> &toRMQs,
                         vector<vector<Node>> &Trees);
...
//    int QuerySamePartiCH(int ID1, int ID2);
    ...
    void EffiCheckStages(vector<pair<int, int>> &ODpair, int runtimes, int intervalT, unsigned long long &throughputNum,
    ...
    void GetBatchThroughput(vector<double> &queryTimes, int intervalT, unsigned long long &throughputNum,
    ...
    int QueryPMHL(int ID1,
                  int ID2);//algoQuery: 0: Dijkstra; 1: PCH-No; 2: PH2H-No; 3: PCH-Post; 4: PH2H-Post; 5: PH2H-Extend
    ...
    void
    RealUpdateThroughputTestQueueModel(string updateFile, int batchNumTest, double T_r, int workerNum, int regionNum);

    void
    RandomUpdateThroughputTestQueueModel(int batchNum, int batchSize, int batchInterval, double T_r, int workerNum);

    void SPThroughputTest(int updateType, bool ifBatch, int batchNum, int batchSize, int batchInterval, int runtimes);

    void DecBatchThroughput(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, int batch_i,
                            double &runT1);//process batch update
    void IncBatchThroughput(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, int batch_i,
                            double &runT1);//process batch update
    void DecBatchThroughputNP(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, int batch_i,
                              double &runT1);//process batch update
    void EachNodeProBDis5H2H(int child, vector<int> &line, set<int> &vertexIDChL, map<int, int> &checkedDis);

    void IncBatchThroughputNP(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, int batch_i,
                              double &runT1);//process batch update
    ...
    void DecreaseOverlay(int a, int b, int newW, vector<unordered_map<vertex, int>> &Neighbors, vector<Node> &Tree,
                         vector<int> &rank, int heightMax);

    void DecreaseParti(int a, int b, int newW, vector<vector<pair<int, int>>> &Neighbors, vector<Node> &Tree,
                       vector<int> &rank, int heightMax);

    void EachNodeProBDis5(int child, vector<int> &line, set<int> &vertexIDChL, vector<Node> &Tree,
                          vector<int> &rank);//map<int,int>& checkedDis,
    void EachNodeProBDis5PostMHLOverlay(int child, vector<int> &line, set<int> &vertexIDChL, vector<Node> &Tree,
                                        vector<int> &rank);//map<int,int>& checkedDis,
    void EachNodeProBDis5Parti(int child, vector<int> &line, set<int> &vertexIDChL, vector<Node> &Tree,
                               vector<int> &rank);//map<int,int>& checkedDis, map<int,int>& checkedDis,
    void
    IncreaseOverlay(int a, int b, int oldW, int newW, vector<unordered_map<int, int>> &Neighbors, vector<Node> &Tree,
                    vector<int> &rank, int heightMax, vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                    vector<vector<int>> &VidtoTNid);

    void
    eachNodeProcessIncrease1(int children, vector<int> &line, int &changelabel, vector<Node> &Tree, vector<int> &rank,
                             vector<vector<int>> &VidtoTNid);

    void eachNodeProcessIncrease1PostMHL(int children, vector<int> &line, int &changelabel, vector<Node> &Tree,
                                         vector<int> &rank, vector<vector<int>> &VidtoTNid);

    void eachNodeProcessIncrease1PostMHLOverlay(int children, vector<int> &line, int &changelabel, vector<Node> &Tree,
                                                vector<int> &rank, vector<vector<int>> &VidtoTNid);

    void IncreaseParti(int a, int b, int oldW, int newW, vector<vector<pair<int, int>>> &Neighbors, vector<Node> &Tree,
                       vector<int> &rank, int heightMax, vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                       vector<vector<int>> &VidtoTNid);

    void eachNodeProcessIncrease1Parti(int children, vector<int> &line, int &changelabel, vector<Node> &Tree,
                                       vector<int> &rank, vector<vector<int>> &VidtoTNid);

    void DecreaseOverlayBatch(vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                              vector<unordered_map<int, int>> &Neighbor, vector<Node> &Tree, vector<int> &rank,
                              int heightMax, bool ifLabelU);//batch decrease for overlay graph
    void
    DecreaseH2HBatch(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<vector<pair<int, int>>> &Neighbor,
                     vector<Node> &Tree, vector<int> &rank, int heightMax, bool ifLabelU);

    void DecreaseOverlayBatchPostMHL(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree,
                                     vector<int> &rank, int heightMax, bool ifLabelU);//batch decrease for overlay graph
    void DecreaseOverlayBatchLabelPostMHL(vector<Node> &Tree, vector<int> &rank, int heightMax,
                                          vector<int> &ProBeginVertexSet, set<int> &vertexIDChL);

    void DecreasePartiBatchLabelPostMHLExtendV(vector<int> &p, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                               vector<vector<int>> &ProBeginVertexSetV, set<int> &vertexIDChL);

    void DecreasePartiBatchLabelPostMHLExtend(int pid, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                              vector<int> &ProBeginVertexSet, set<int> &vertexIDChL);

    void DecreaseOverlayBatchLabel(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                                   set<int> &vertexIDChL);

    void DecreasePartiBatchUpdateCheck(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                                       vector<pair<pair<int, int>, pair<int, int>>> &weightOverlay);

    void DecreasePartiBatchUpdateCheckCH(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                                         vector<pair<pair<int, int>, pair<int, int>>> &weightOverlay, bool ifOpt,
                                         vector<pair<pair<int, int>, int>> &updatedSC);

    void DecreasePartiBatchUpdateCheckCHV(vector<int> p, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &wBatch,
                                          vector<pair<pair<int, int>, pair<int, int>>> &weightOverlay, bool ifOpt,
                                          vector<vector<pair<pair<int, int>, int>>> &updatedSC);

    void DecreasePartiBatchUpdateCheckPostMHL(map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch,
                                              vector<pair<pair<int, int>, pair<int, int>>> &overlayBatch,
                                              bool ifParallel);

    void DecreasePartiBatch(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                            vector<vector<pair<int, int>>> &Neighbors, vector<Node> &Tree, vector<int> &rank,
                            int heightMax, vector<pair<pair<int, int>, int>> &updatedSC, bool ifLabelU);

    void DecreasePartiBatchForOpt(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                                  vector<vector<pair<int, int>>> &Neighbors, vector<Node> &Tree, vector<int> &rank,
                                  int heightMax, vector<pair<pair<int, int>, int>> &updatedSC, bool ifLabelU,
                                  bool ifConstruct);

    void
    DecreasePartiBatchPostMHLShortcut(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree,
                                      vector<int> &rank, int heightMax, vector<pair<pair<int, int>, int>> &updatedSC);

    void
    DecreasePartiBatchPostMHLShortcutV(vector<int> p, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &wBatch,
                                       vector<Node> &Tree, vector<int> &rank, int heightMax,
                                       vector<vector<pair<pair<int, int>, int>>> &updatedSCs);

    void DecreasePartiBatch(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                            vector<unordered_map<int, int>> &Neighbors, vector<Node> &Tree, vector<int> &rank,
                            int heightMax, bool ifLabelU, bool ifPost);

    void DecreasePartiBatchLabel(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                                 set<int> &vertexIDChL);

    void DecreasePartiBatchLabelV(vector<int> p, vector<vector<Node>> &Trees, vector<vector<int>> &ranks,
                                  vector<int> &heightMaxs, vector<vector<int>> &ProBeginVertexSets,
                                  vector<set<int>> &vertexIDChLs);

    void IncreaseOverlayBatch(vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                              vector<unordered_map<int, int>> &Neighbor, vector<Node> &Tree, vector<int> &rank,
                              int heightMax, vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                              vector<vector<int>> &VidtoTNid, bool ifLabelU);

    void
    IncreaseH2HBatch(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<vector<pair<int, int>>> &Neighbor,
                     vector<Node> &Tree, vector<int> &rank, int heightMax,
                     vector<map<int, vector<pair<int, int>>>> &SCconNodesMT, vector<vector<int>> &VidtoTNid,
                     bool ifLabelU);

    void IncreaseOverlayBatchPostMHL(vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree,
                                     vector<int> &rank, int heightMax,
                                     vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                                     vector<vector<int>> &VidtoTNid, bool ifLabelU);

    void IncreaseOverlayBatchLabelPostMHL(vector<Node> &Tree, vector<int> &rank, int heightMax,
                                          vector<int> &ProBeginVertexSet, vector<vector<int>> &VidtoTNid);

    void IncreaseOverlayBatchLabel(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                                   vector<vector<int>> &VidtoTNid);

    void IncreasePartiBatchUpdateCheck(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                                       vector<pair<pair<int, int>, pair<int, int>>> &weightOverlay);

    void IncreasePartiBatchUpdateCheckCH(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                                         vector<pair<pair<int, int>, pair<int, int>>> &weightOverlay, bool ifOpt,
                                         vector<pair<pair<int, int>, int>> &updatedSC);

    void IncreasePartiBatchUpdateCheckCHV(vector<int> p, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &wBatch,
                                          vector<pair<pair<int, int>, pair<int, int>>> &overlayBatch, bool ifOpt,
                                          vector<vector<pair<pair<int, int>, int>>> &updatedSCs);

    void IncreasePartiBatchUpdateCheckPostMHL(map<int, vector<pair<pair<int, int>, pair<int, int>>>> &partiBatch,
                                              vector<pair<pair<int, int>, pair<int, int>>> &overlayBatch,
                                              bool ifParallel);

    void IncreasePartiBatch(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                            vector<vector<pair<int, int>>> &Neighbors, vector<Node> &Tree, vector<int> &rank,
                            int heightMax, vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                            vector<vector<int>> &VidtoTNid, vector<pair<pair<int, int>, int>> &updatedSC,
                            bool ifLabelU);

    void IncreasePartiBatchForOpt(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                                  vector<vector<pair<int, int>>> &Neighbors, vector<Node> &Tree, vector<int> &rank,
                                  int heightMax, vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                                  vector<vector<int>> &VidtoTNid, vector<pair<pair<int, int>, int>> &updatedSC,
                                  bool ifLabelU);
    ...
    void
    IncreasePartiBatchPostMHLShortcut(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch, vector<Node> &Tree,
                                      vector<int> &rank, int heightMax, vector<pair<pair<int, int>, int>> &updatedSC,
                                      vector<int> &PropagateOverlay);

    void
    IncreasePartiBatchPostMHLShortcutV(vector<int> p, map<int, vector<pair<pair<int, int>, pair<int, int>>>> &wBatch,
                                       vector<Node> &Tree, vector<int> &rank, int heightMax,
                                       vector<vector<pair<pair<int, int>, int>>> &updatedSCs,
                                       vector<int> &PropagateOverlay);
    ...
    void IncreasePartiBatch(int pid, vector<pair<pair<int, int>, pair<int, int>>> &wBatch,
                            vector<unordered_map<int, int>> &Neighbors, vector<Node> &Tree, vector<int> &rank,
                            int heightMax, vector<map<int, vector<pair<int, int>>>> &SCconNodesMT,
                            vector<vector<int>> &VidtoTNid, bool ifLabelU, bool ifPost);

    void IncreasePartiBatchLabel(vector<Node> &Tree, vector<int> &rank, int heightMax, vector<int> &ProBeginVertexSet,
                                 vector<vector<int>> &VidtoTNid);

    void IncreasePartiBatchLabelV(vector<int> p, vector<vector<Node>> &Trees, vector<vector<int>> &ranks,
                                  vector<int> &heightMaxs, vector<vector<int>> &ProBeginVertexSet,
                                  vector<vector<int>> &VidtoTNid);

    void IncreasePartiBatchLabelPostMHLExtendV(vector<int> &p, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                               vector<vector<int>> &ProBeginVertexSetV, vector<vector<int>> &VidtoTNid);

    void IncreasePartiBatchLabelPostMHLExtend(int pid, vector<Node> &Tree, vector<int> &rank, int heightMax,
                                              vector<int> &ProBeginVertexSet, vector<vector<int>> &VidtoTNid);
