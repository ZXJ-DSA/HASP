...
//                exit(1);
        ...
        cout<<"Batch "<<batch_i<<" . Decrease update number: "<<wBatchDec.size()<<" ; Increase update number: "<<wBatchInc.size()<<endl;
        updateTime=0;
...
//            cout<<"Estimated throughput: "<<resultE.first<<" ; fastest available query time: "<<resultE.second*1000<<" ("<<fastQT<<") ms"<<endl;
        throughputNum = ThroughputSimulate(stageQueryThis,stageUpdateT,batchInterval,T_r,batchInterval,fastQT,workerNum);//2 batches update
...
//    cout<<"\nPartiNum: "<<partiNum<<". Throughput: "<<throughputNum<<" ; Average batch update Time: "<<runT/batchNum<<" s."<<endl;
    ...
    cout<<"\nPartiNum: "<<partiNum<<". Average Throughput: "<<aveThr/throughputNums.size()<<" ; Average batch update Time: "<<runT/count<<" s"<<endl;
